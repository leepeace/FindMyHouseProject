...
<form id="form-no-param" method="get" action="${root}/board">
	<input type="hidden" id="nact" name="act" value="mvmodify"> <input
		type="hidden" id="npgno" name="pgno" value="${param.pgno}"> <input
		type="hidden" id="nkey" name="key" value="${param.key}"> <input
		type="hidden" id="nword" name="word" value="${param.word}"> <input
		type="hidden" id="nword" name="subject" value="${article.subject}">
	<input type="hidden" id="nword" name="content"
		value="${article.content}"> <input type="hidden"
