...
import com.ssafy.member.exception.UnAuthorizedException;
...
//	AccessToken에 비해 유효기간을 길게...
	...
	public <T> String createRefreshToken(String key, T data) {
		return create(key, data, "refresh-token", 1000 * 60 * 60 * 24 * 14 * REFRESH_TOKEN_EXPIRE_MINUTES);
	}
...
//			}
	 ...
	 */
	@Override
	public boolean checkKakaoToken(String token) {
		...
		//페이로드의 exp 값이 현재 UNIX 시간보다 큰 값인지 확인
		if((long)jsonArray.get("exp") < (long)(System.currentTimeMillis()/1000)) {
			return false;
		}
